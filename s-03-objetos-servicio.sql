...
CREATE TABLE CLIENTE(
    CLIENTE_ID        NUMBER(40, 0)    NOT NULL,
...
CREATE TABLE COTIZACION_SERVICIO(
    COTIZACION_SERVICIO_ID    NUMBER(40, 0)    NOT NULL,
    PRECIO                    NUMBER(10, 0)    NOT NULL,
    DESCRIPCION               VARCHAR2(150)    NOT NULL,
    MENSUALIDADES             NUMBER(2, 0),
    SERVICIO_ID               NUMBER(40, 0)    NOT NULL,
    USING INDEX (
...
CREATE TABLE ESTATUS_SERVICIO(
    ESTATUS_SERVICIO_ID    VARCHAR2(40)    NOT NULL,
...
CREATE TABLE HIST_ESTATUS_SERVICIO(
    HIST_ESTATUS_SERVICIO    NUMBER(40, 0)    NOT NULL,
...
CREATE TABLE PAGO(
    SERVICIO_ID           NUMBER(40, 0)    NOT NULL,
    TARJETA_CLIENTE_ID    NUMBER(40, 0)    NOT NULL,
...
CREATE TABLE RESULTADO_SERVICIO(
    RESULTADO_SERVICIO_ID    NUMBER(40, 0)    NOT NULL,
...
CREATE TABLE SERVICIO(
    ...
    DESCRIPCION_DETALLADA    RAW(40)           NOT NULL,
...
CREATE TABLE TARJETA_CLIENTE(
    ...
    USING INDEX (
        ...
        TABLESPACE SERVICIO_INDEXES_TBS
    ) TABLESPACE SERVICIO_ENCRYPT_TBS
)
;
