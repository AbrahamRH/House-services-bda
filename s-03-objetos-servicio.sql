...
grant references on cliente to ralu_s02;
...
PROMPT TABLE COTIZACION_SERVICIO
...
PROMPT TABLE HIST_ESTATUS_SERVICIO
CREATE TABLE HIST_ESTATUS_SERVICIO(
    HIST_ESTATUS_SERVICIO_ID    NUMBER(30, 0)    NOT NULL,
    FECHA_ESTATUS            DATE             NOT NULL,
    SERVICIO_ID              NUMBER(30, 0)    NOT NULL,
    ESTATUS_SERVICIO_ID      VARCHAR2(30)     NOT NULL,
    CONSTRAINT HIST_ESTATUS_SERVICIO_PK PRIMARY KEY (HIST_ESTATUS_SERVICIO_ID)
    USING INDEX (
...
CREATE TABLE PAGO(
    ...
    USING INDEX (
        CREATE UNIQUE INDEX PAGO_PK ON PAGO(SERVICIO_ID,TARJETA_CLIENTE_ID)
        TABLESPACE SERVICIO_INDEXES_TBS
)
    ) TABLESPACE SERVICIO_MULTIPLE_TBS
;
...
PROMPT TABLE RESULTADO_SERVICIO CREATE TABLE RESULTADO_SERVICIO(
...
grant references on tarjeta_cliente to ralu_s01;
...
ALTER TABLE PAGO ADD CONSTRAINT PAGO_TARJETA_CLIENTE_ID_FK 
    ...
    REFERENCES RALU_S02.TARJETA_CLIENTE(TARJETA_CLIENTE_ID)
;
...
CREATE INDEX SERVICIO_PROVEEDOR_ID_FK ON SERVICIO(PROVEEDOR_ID)
TABLESPACE SERVICIO_INDEXES_TBS;
...
connect ralu_s02/ralu_s02
ALTER TABLE RALU_S02.TARJETA_CLIENTE ADD CONSTRAINT TARJETA_CLIENTE_CLIENTE_ID_FK 
    FOREIGN KEY (CLIENTE_ID)
    REFERENCES RALU_S01.CLIENTE(CLIENTE_ID)
;

CREATE INDEX TARJETA_CLIENTE_CLIENTE_ID_FK ON RALU_S02.TARJETA_CLIENTE(CLIENTE_ID)
TABLESPACE SERVICIO_INDEXES_TBS;
...
RALU_S02.TARJETA_CLIENTE(NUMERO_TARJETA) TABLESPACE SERVICIO_INDEXES_TBS;
